...
class SiteController extends Controller
{
    ...
    {         
        if (Yii::$app->user->isGuest) return $this->redirect('http://180.250.145.147:8007');
    ...
    public function actionLogin()
    {
        ...
        return $this->redirect('http://180.250.145.147:8007');
    }

    public function actionSignOut()
    {  
        Yii::$app->response->redirect('http://180.250.145.147:8007', 301);
        Yii::$app->end();
    }
