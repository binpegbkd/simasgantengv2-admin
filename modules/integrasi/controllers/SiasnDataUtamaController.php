...
class SiasnDataUtamaController extends Controller
{
    ...
    public function actionHapusGol($id)
    {
        $model = SiasnRwGolongan::findOne($id);
        if($model->delete()){
    ...
    public function actionHapusJab($id)
    {        
        ...
        $hapus = SiasnConfig::apiDelete($mode, $url, 'application/json', $ws['token_key'], $sso['token_sso']);
    ...
    public function actionHapusDiklat($id)
    {        
        $sess = Yii::$app->session;
        $mode = 'prod';
        $ws = SiasnConfig::getTokenWSO2($mode);
        ...
        $model = SiasnRwDiklat::findOne($id);
        $url = '/diklat/delete/'.$id;
        $hapus = SiasnConfig::apiDelete($mode, $url, 'application/json', $ws['token_key'], $sso['token_sso']);
    ...
    public function actionHapusKursus($id)
    {        
        $sess = Yii::$app->session;
        $mode = 'prod';
        $ws = SiasnConfig::getTokenWSO2($mode);
        ...
        $model = SiasnRwKursus::findOne($id);
        $url = '/kursus/delete/'.$id;
        $hapus = SiasnConfig::apiDelete($mode, $url, 'application/json', $ws['token_key'], $sso['token_sso']);
