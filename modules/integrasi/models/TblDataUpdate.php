...
class TblDataUpdate extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['id', 'nipBaru'], 'required'],
            [['dataUtama', 'rwJabatan', 'rwGol', 'rwDiklat', 'rwPendidikan', 'rwSkp', 'rwAngkakredit', 'rwPwk', 'rwPnsunor', 'rwKursus', 'rwPemberhentian', 'rwPenghargaan', 'rwMasakerja', 'rwHukdis', 'rwDp3', 'rwCltn', 'rwPindahinstansi', 'rwskp22', 'simpeg', 'auth', 'preskin', 'simgaji'], 'safe'],
