...
class SiasnRwJabatan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['flag'], 'integer'],
            [['id', 'idPns', 'instansiKerjaId', 'satuanKerjaId', 'unorId', 'unorIndukId', 'jabatanFungsionalId', 'jabatanFungsionalUmumId', 'jenisPenugasanId', 'jenisMutasiId', 'subJabatanId'], 'string', 'max' => 128],
