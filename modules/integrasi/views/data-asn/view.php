...
<div class="site-index">
    ...
    <div class="row">
        <div class="ml-auto mr-auto">
            <?= Html::a('<i class="fas fa-cloud-download-alt"></i>', ['sync-data-utama', 'nip' => $ses['nip']], ['title' => 'Unduh dari SIASN', 'class' => 'btn btn-success']); ?>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <table id="table1" class="table table-bordered table-hover" width="100%">
                ...
                <tbody style="font-size:13px">
                    ...
                    <?php //echo cekData('E-mail', $ses['simpeg']['email'], $ses['siasn']['email'], 'email', 'email') ?>
                    ...
                    <?php //echo cekData('Kartu ASN', $ses['simpeg']['kartu_asn'], $ses['siasn']['kartuAsn'], 'kartu_asn', 'kartuAsn') ?>
                    <!--
                    <tr>
                        <td>Pangkat/ Gol</td>
