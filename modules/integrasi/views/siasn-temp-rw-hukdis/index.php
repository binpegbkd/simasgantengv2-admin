...
/* @var $searchModel app\modules\integrasi\models\SiasnTempRwHukdisSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Siasn Temp Rw Hukdis';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="siasn-temp-rw-hukdis-index">

    <p>
        <?=  Html::button('<i class="fas fa-plus-circle"></i> Tambah', ['value' => Url::to(['create']), 'title' => 'Tambah Siasn Temp Rw Hukdis', 'class' => 'showModalButton btn btn-success']); ?>
    </p>
