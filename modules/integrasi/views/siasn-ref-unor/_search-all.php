...
<div class="siasn-ref-unor-search">
    ...
    <?= $form->field($model, 'namaUnor', ['showLabels' => true])->textInput(['placeholder' => 'NAMA', 'size' => '50%']) ?>
    <!--
    <?= $form->field($model, 'simpeg', ['showLabels' => true])->textInput(['placeholder' => 'KODE SIMPEG', 'size' => '10%']) ?>
    <?= $form->field($model, 'aktif', ['showLabels' => true])->textInput(['placeholder' => 'AKTIF', 'size' => '5%']) ?>
    -->
