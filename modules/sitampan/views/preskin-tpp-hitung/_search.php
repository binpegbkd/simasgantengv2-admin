...
<div class="preskin-tpp-hitung-search mb-10">
    ...
    <?php $form = ActiveForm::begin([
        ...
        'fieldConfig' => ['options' => ['class' => 'form-group mr-2 mb-2']], 
    ]); ?>
    ...
    <?= $form->field($model, 'nama_opd') ?>

    <?= $form->field($model, 'nama_unor') ?>

    <?php // echo $form->field($model, 'jtrans') ?>
    ...
    <div class="form-group">
        ...
        <?= Html::a('Clear', ['pns'], ['class' => 'btn btn-danger', 'title' => 'Clear']) ?>
    </div>
