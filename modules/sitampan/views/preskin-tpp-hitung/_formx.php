...
<div class="preskin-tpp-hitung-form">
    ...
    <?= $form->field($model, 'jtrans')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'jenis_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kode_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nama_jab')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'nama_unor')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'gol')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nama_gol')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pagu')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'persen_tpp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'beban_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'beban_opd')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kondisi_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kondisi_opd')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pol_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pol_opd')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'prestasi_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'prestasi_opd')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tempat_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tempat_opd')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'profesi_jab')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'persen_tpp_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'beban_jab_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'beban_opd_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kondisi_jab_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'kondisi_opd_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pol_jab_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pol_opd_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'prestasi_jab_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'prestasi_opd_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tempat_jab_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tempat_opd_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'profesi_jab_rp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pagu_total')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'pagu_tpp')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'beban_kerja')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'produktivitas_kerja')->textInput(['maxlength' => true]) ?>
