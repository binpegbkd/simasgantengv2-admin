...
/* @var $searchModel app\modules\sitampan\models\PreskinHariKerjaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Hari Kerja';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="preskin-hari-kerja-index">

    <p>
        <?=  Html::button('<i class="fas fa-plus-circle"></i> Tambah', ['value' => Url::to(['create']), 'title' => 'Tambah Preskin Hari Kerja', 'class' => 'showModalButton btn btn-success']); ?>
    </p>
