...
<div class="preskin-asn-index">
    ...
    <?=  Html::button('<i class="fas fa-plus-circle"></i> Tambah', ['value' => Url::to(['create']), 'title' => 'Tambah Preskin Asn', 'class' => 'showModalButton btn btn-success mb-1']); ?>

    <?=  Html::a('<i class="fas fa-search"></i> Cari Data', '#', ['title' => 'Cari Data', 'class' => 'btn btn-primary float-right mb-1', 'id' => 'search']); ?>
