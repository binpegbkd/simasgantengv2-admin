...
$config = [
    'id' => 'simasganteng2-admin',
    'name' => 'Simasganteng 2.0 - Administrator',
    ...
    'components' => [
        ...
        'session' => [
            ...
            'name' => 'bkpsdmd-brebeskab-app-admin',
        ...
        'user' => [
            ...
            'identityCookie' => ['name' => '_identity-app-admin', 'httpOnly' => true],
            'authTimeout' => 3600,
        ],
        'errorHandler' => [
    ...
    'modules' => [
        ...
        'efi' => [
            'class' => 'app\modules\efi\Efi',
        ],
        'gaji' => [
            'class' => 'app\modules\gaji\Gaji',
        ],
        'simpeg' => [
            'class' => 'app\modules\simpeg\Simpeg',
        ],
        'siasn' => [
            'class' => 'app\modules\siasn\Siasn',
        ],
        'integrasi' => [
