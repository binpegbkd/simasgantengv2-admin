...
<header id="header" style="background-color:white;">
    ...
    if($session['module'] == 3){
        ...
        $items = [
            ['label' => 'Data ASN', 'url' => ['/data-integrasi'], 'options' => ['title' => 'Data ASN']],
            ['label' => 'Data Pribadi', 'url' => ['/data-profil'], 'options' => ['title' => 'Data Pribadi']],
            ['label' => 'CPNS/ PNS', 'url' => ['/data-cpns-pns'], 'options' => ['title' => 'CPNS/ PNS']],
            ['label' => 'Data Riwayat', 'url' => '#', 'items' => [
                ['label' => 'Pangkat/ Gol', 'url' => ['/data-pangkat'], 'options' => ['title' => 'Riwayat Pangkat/ Gol']],
                ['label' => 'Jabatan', 'url' => ['/jabatan'], 'options' => ['title' => 'Riwayat Jabatan']],
                ['label' => 'Unor', 'url' => ['/rw-unor'], 'options' => ['title' => 'Riwayat Unit Kerja']],
                ['label' => 'Pendidikan', 'url' => ['/pendidikan'], 'options' => ['title' => 'Riwayat Pendidikan']],
                ['label' => 'Diklat', 'url' => ['/diklat'], 'options' => ['title' => 'Riwayat Diklat']],
                ['label' => 'SKP', 'url' => ['/skp'], 'options' => ['title' => 'Riwayat SKP']],
                ['label' => 'Angka Kredit', 'url' => ['/ak'], 'options' => ['title' => 'Riwayat Angka Kredit']],
                ['label' => 'Hukdis', 'url' => ['/hukdis'], 'options' => ['title' => 'Riwayat Hukuman Disiplin']],
                ['label' => 'Penghargaan', 'url' => ['/penghargaan'], 'options' => ['title' => 'Riwayat Penghargaan']],
            ]],
        ];
    }else{
        $app_name = '';
